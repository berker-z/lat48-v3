...
export const PartnersSection: React.FC<SectionProps> = ({ id = 'partners' }) => (
  <section className="section" id={id}>
    <SectionHeader title="Partners" id={id} />
...
export const EventsSection: React.FC<SectionProps> = ({ id = 'events' }) => (
  <section className="section" id={id}>
    <SectionHeader title="Events" id={id} />
    <div className="card border-nord-3">
